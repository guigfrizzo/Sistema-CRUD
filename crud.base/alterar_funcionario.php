...
<body>
    <div class="form-container">
        ...
        <form action="update_funcionario.php" method="post" autocomplete="off">
            ...
            <label for="Emp_lname">Sobrenome do funcionário</label>
            <input type="text" name="Emp_lname" id="Emp_lname" placeholder="Informe o sobrenome do funcionário" required>
